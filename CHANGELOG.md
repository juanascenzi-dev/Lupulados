...
- La calculadora de barriles ahora arma pedidos de bebidas espirituosas: "Usar esta recomendación" agrega al carrito, además de la cerveza, botellas reales de las bebidas activas en la mezcla (fernet, vino, gin, vodka, whisky, ron, tequila), resolviendo el producto y la cantidad contra el catálogo comercial. Funciona también con mezclas 100% espirituosas, sin cerveza. Se habilitó además el pedido manual de vodka, ron y tequila desde "Armá tu pedido" (antes solo estaban disponibles vino, fernet, gin y whisky).
