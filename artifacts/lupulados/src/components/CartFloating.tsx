    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-4 left-[max(1rem,env(safe-area-inset-left))] z-30 flex min-h-12 min-w-12 max-w-[calc(100vw-2rem)] items-center justify-center rounded-full border border-amber-300 bg-primary p-3 font-bold text-black shadow-[0_0_20px_rgba(217,119,6,0.4)] sm:bottom-6 sm:left-[max(1.5rem,env(safe-area-inset-left))] sm:gap-3 sm:px-4 sm:py-3"
        ...
        >
          ...
          <div className="hidden flex-col items-start pr-2 sm:flex">
            <span className="text-xs uppercase tracking-wider opacity-80 leading-none">
              Ver Pedido
            </span>
